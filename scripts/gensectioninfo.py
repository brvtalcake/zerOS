...
def main() -> int:
    ...
    rs_extern_sym = Template("""
unsafe extern "C"
{
    pub unsafe static zerOS_${symbol}_start: LinkerSym;
    pub unsafe static zerOS_${symbol}_end  : LinkerSym;
}
""")
...
"""
    ...
    rs_ksyms = rs_extern_sym.substitute(symbol="kernel")
