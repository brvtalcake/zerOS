...
#define __KLIBC_PP_EXPAND_II(...) __KLIBC_PP_EXPAND_III(__KLIBC_PP_EXPAND_III(__KLIBC_PP_EXPAND_III(__KLIBC_PP_EXPAND_III(__KLIBC_PP_EXPAND_III(__KLIBC_PP_EXPAND_III(__VA_ARGS__))))))
#define __KLIBC_PP_EXPAND_III(...) __VA_ARGS__
